...
function _onLoad() {
  _onLoad = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var MODEL_URL, WEIGHTS_URL, TENSOR_EDGE, model;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log('onLoad loaded');
            MODEL_URL = "preTrained\\tensorflowjs_model.pb";
            WEIGHTS_URL = "preTrained\\weights_manifest.json"; // Model's input and output have width and height of 513.

            TENSOR_EDGE = 513;
            _context.next = 6;
            return tf.loadGraphModel(WEIGHTS_URL);
