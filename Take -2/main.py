...
from Reference.src.models.modnet import MODNet
...
pretrained_ckpt = r'Reference\pretrained\modnet_webcam_portrait_matting.ckpt'
...
while(True):
    ...
    bg = cv2.imread('background7.jpg')
    bg = cv2.resize(bg,(frame_np.shape[1],frame_np.shape[0]))
